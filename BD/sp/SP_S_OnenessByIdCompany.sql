...
-- =============================================
CREATE PROCEDURE SP_S_OnenessByIdCompany
...
BEGIN
BEGIN TRY
	IF((SELECT COUNT(*) FROM company WHERE ID=@IdCompany and ACTIVE=1)=0)
	BEGIN
		RAISERROR('LA EMPRESA NO EXISTE O ESTA SUSPENDIDA' ,16 ,1)
	END
